...
const Header = () => (
  ...
  const CompanyDetails = () => (
    <div style={{ textAlign: "center", margin: "10px 0",  color: "gray", }}>
      ...
      <p>Tel: 2291150, WH.Tel: 3479590, Fax: 2257800, P.O. Box – 65440, Dubai-U.A.E.</p>
  ...
  const CustomerOrderDetails = () => (
    <div style={detailsContainer}>
      <div>
        <p><strong>A/C NO:</strong> 123456789</p>
        <p><strong>Cust. Name:</strong> John Doe</p>
        <p><strong>Cust. TRN:</strong> TRN-987654321</p>
        <p><strong>Mob:</strong> +971 50 123 4567</p>
      </div>
      <div>
        <p><strong>Order Doc No:</strong> 987654</p>
        <p><strong>Date:</strong> 26/03/2025</p>
        <p><strong>Salesman Name:</strong> Gokul</p>
        <p><strong>Location:</strong> Kannur</p>
      </div>
    </div>
  );
  ...
  const Footer = () => (
    <div style={footerStyle}>
      <p>Thank you for your business! For any inquiries, contact us at rasti@rastilari.com</p>
